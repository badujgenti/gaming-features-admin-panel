...
პროექტი სამ დამოუკიდებელ gaming ფიჩერს მართავს: ლიდერბორდები, გათამაშებები და საპრიზო ბორბლები. თითოეული ფიჩერი სრულიად დამოუკიდებელია — აქვს საკუთარი API ფენა, კომპონენტები, გვერდები, ვალიდაციის სქემები და ტიპები. ფიჩერებს შორის იმპორტი აკრძალულია. ეს ნიშნავს, რომ ერთ ფიჩერში მომხდარი შეცდომა (ErrorBoundary-ით დაჭერილი) არ ახდენს ეფექტს დანარჩენებზე. გუნდის წევრებს შეუძლიათ სრული ფიჩერის მფლობელობა merge conflict-ების გარეშე. ახალი ფიჩერის დამატება ნიშნავს ახალი დირექტორიის შექმნას `features/`-ში და მარშრუტების რეგისტრაციას `routes.tsx`-ში — არსებული კოდი არ იცვლება.
